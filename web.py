...
CONTEXT_ARTICLES = 3      # статей в контексте. Баланс: главный выигрыш скорости даёт
                          # резидентное хранение моделей (без перезагрузок), поэтому здесь
                          # можно 3 статьи ради полноты (2 давали лишние «недостаточно данных»).
CONTEXT_CHARS = 900       # символов на статью (ключевая норма — в начале статьи)
